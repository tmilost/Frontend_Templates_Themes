            ...
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-description">
                  Use
                  <code>variant="color"</code> for basic styled dropdown
                </p>
          ...
          <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-description">
                  Use
                  <code>variant="outline-*"</code> for outline styled dropdown
                </p>
                <div class="template-demo">
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">
              Use
              <code>split</code> prop for split dropdown
            </p>
            <div class="template-demo">
      ...
      <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">
              Use
              <code>dropup</code> prop to use a dropup
            </p>
            <div class="template-demo">
      ...
      <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">
              Use
              <code>size="*"</code> for different dropdown sizing
            </p>
