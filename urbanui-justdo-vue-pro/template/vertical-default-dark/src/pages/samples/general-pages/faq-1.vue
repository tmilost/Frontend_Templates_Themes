              ...
              <div role="tablist" class="accordion">
                <b-card no-body>
                  <b-card-header header-tag="header" role="tab">
                    ...
                    >How many instances of Lorum Ipsum usage can be found on the web?</a>
                  </b-card-header>
                ...
                <b-card no-body>
                  <b-card-header header-tag="header" role="tab">
                    ...
                    >What is Lorum Ipsum and who invented it?</a>
                  </b-card-header>
                ...
                <b-card no-body>
                  <b-card-header header-tag="header" role="tab">
                    ...
                    >What should I do if I need any assistance using my account</a>
                  </b-card-header>
