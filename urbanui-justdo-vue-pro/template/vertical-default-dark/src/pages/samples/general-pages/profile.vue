              ...
              <div class="col-lg-4">
                <div class="border-bottom text-center pb-4">
                  ...
                  <div class="d-block d-sm-flex justify-content-between">
                    <b-button variant="success">Hire Me</b-button>
                    <b-button variant="success">Follow</b-button>
                  </div>
                </div>
                ...
                <b-button variant="primary btn-block">Preview</b-button>
              </div>
              <div class="col-lg-8">
                <div class="d-lg-flex justify-content-between">
                  <div>
                    <h3 class="mt-3 mt-lg-0">David Grey. H</h3>
                    ...
                    <div class="ml-4">
                      <h6>
                        ...
                        <small class="ml-4 text-muted">
                          <i class="ti-alarm-clock mr-1"></i>10 hours
                        </small>
                      </h6>
                      ...
                      <p class="small text-muted mt-2 mb-0">
                        ...
                        <span class="ml-2">
                          <i class="ti-comment-alt mr-1"></i>11
                        </span>
                        <span class="ml-2">
                          <i class="ti-share"></i>
                        </span>
