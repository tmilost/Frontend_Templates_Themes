        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="page-description">
              Use
              <code>&lt;b-progress&gt;</code> for basic progressbar
            </p>
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="page-description">
              Use
              <code>variant="*"</code> for styled progressbar
            </p>
            <div class="template-demo">
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="page-description">
              Use
              <code>striped</code> prop for striped progressbar
            </p>
            <div class="template-demo">
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="page-description">
              Use
              <code>striped :animated="animate"</code> prop for animated progressbar
            </p>
            <div class="template-demo">
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="page-description">
              Use
              <code>show-progress</code> prop for label
            </p>
            <div class="template-demo">
