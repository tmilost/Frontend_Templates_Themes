        ...
        <div class="card bg-primary border-0 position-relative">
          <div class="card-body">
            ...
            <slick
              ...
              class="performance-overview pt-2"
            >
              <div>
                <template>
                  <div class="row">
                    <div class="col-md-4 item">
                      <div class="d-flex flex-column flex-xl-row mt-4 mt-md-0">
                        ...
                        <div class="content text-white">
                          ...
                          <p
                            class="text-white font-weight-light pr-lg-2 pr-xl-5"
                          >
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div id="sales-legend" class="chartjs-legend mt-4 mb-2">
              <ul>
                <li><span></span>Offline Sales</li>
                <li><span></span>Online Sales</li>
              </ul>
            </div>
                    ...
                    <div class="col-md-12 col-xl-9">
                      <div class="row">
                        ...
                        <div class="col-md-6 mt-3 aligner-wrapper">
                          ...
                          <div
                            id="north-america-legend"
                            class="circle-america-legend"
                          >
