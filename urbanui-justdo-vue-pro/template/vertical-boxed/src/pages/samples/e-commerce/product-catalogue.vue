                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="product-img-outer">
                      <img
                        class="product_image"
                        src="https://via.placeholder.com/283X216"
                        alt="prduct image"
                      />
                    </div>
                    ...
                    >Product Dimensions: Length (13 Inches) Width (13Inches) & Height (30 Inches).</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item stretch-card">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-12 product-item stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="product-description">
                      Frame size: Lens Length = 16 cm
                      <br />Width = 8.1 cm,Height = 5.6 cm
                    </p>
                  </div>
                </div>
              </div>
