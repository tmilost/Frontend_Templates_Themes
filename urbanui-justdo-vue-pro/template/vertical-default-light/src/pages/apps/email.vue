        ...
        <div class="mail-sidebar d-none d-lg-block col-md-3 pt-3 bg-white">
          <div class="menu-bar">
            <ul class="menu-items">
              ...
              <li>
                <a href="javascript:void(0);">
                  <i class="ti-share"></i> Sent
                </a>
              </li>
              <li>
                <a href="javascript:void(0);">
                  <i class="ti-file"></i> Draft
                </a>
                <span class="badge badge-pill badge-warning">4</span>
              </li>
              <li>
                <a href="javascript:void(0);">
                  <i class="ti-upload"></i> Outbox
                </a>
        ...
        <div class="mail-list-container col-md-4 pt-4 pb-4 border-right bg-white">
          ...
          <div class="mail-list">
            ...
            <div class="content">
              ...
              <p
                class="message_text"
              >Hi Emily, Please be informed that the new project presentation is due Monday.</p>
            </div>
            <div class="details">
              <i class="ti-star"></i>
            </div>
          ...
          <div class="mail-list new_mail">
            ...
            <div class="content">
              ...
              <p
                class="message_text"
              >Change the password for your Microsoft Account using the security code 35525</p>
            </div>
            <div class="details">
          ...
          <div class="mail-list">
            ...
            <div class="content">
              ...
              <p
                class="message_text"
              >Hello, last date for registering for the annual music event is closing in</p>
            </div>
            <div class="details">
              <i class="ti-star"></i>
            </div>
          ...
          <div class="mail-list">
            ...
            <div class="content">
              ...
              <p
                class="message_text"
              >Hi, Please find this week’s monitoring report in the attachment.</p>
            </div>
            <div class="details">
              <i class="ti-star"></i>
            </div>
          ...
          <div class="mail-list">
            ...
            <div class="content">
              ...
              <p
                class="message_text"
              >Template Market: Limited Period Offer!!! 50% Discount on all Templates.</p>
            </div>
            <div class="details">
              <i class="ti-star favorite"></i>
            </div>
          ...
          <div class="mail-list">
            ...
            <div class="content">
              ...
              <p
                class="message_text"
              >Hi Emily, Please approve my leaves for 10 days from 10th May to 20th May.</p>
            </div>
            <div class="details">
              <i class="ti-star"></i>
            </div>
          ...
          <div class="mail-list">
            ...
            <div class="content">
              ...
              <p
                class="message_text"
              >Hello there, Make the most of the limited period offer. Grab your favorites</p>
            </div>
            <div class="details">
              <i class="ti-star"></i>
            </div>
          ...
          <div class="mail-list">
            ...
            <div class="content">
              ...
              <p
                class="message_text"
              >This is the first reminder to complete the online cybersecurity course</p>
            </div>
            <div class="details">
              <i class="ti-star"></i>
            </div>
          ...
          <div class="mail-list">
            ...
            <div class="content">
              ...
              <p
                class="message_text"
              >Dear Employee, As per the regulations all employees are required to complete</p>
            </div>
            <div class="details">
              <i class="ti-star"></i>
            </div>
        ...
        <div class="mail-view d-none d-md-block col-md-5 bg-white">
              ...
              <div class="btn-toolbar">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">
                    <i class="ti-control-forward text-primary"></i> Reply
                  </button>
                  <button type="button" class="btn btn-sm btn-outline-secondary">
                    <i class="ti-control-forward-all text-primary"></i>Reply All
                  </button>
                  <button type="button" class="btn btn-sm btn-outline-secondary">
                    <i class="ti-share text-primary"></i>Forward
                  </button>
                </div>
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">
                    <i class="ti-upload text-primary"></i>Attach
                  </button>
                  <button type="button" class="btn btn-sm btn-outline-secondary">
                    <i class="ti-trash text-primary"></i>Delete
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="message-body">
            <div class="sender-details">
              <img class="img-sm rounded-circle mr-3" src="https://via.placeholder.com/40X40" alt />
              <div class="details">
            ...
            <div class="message-content">
              <p>Hi Emily,</p>
              <p>
                This week has been a great week and the team is right on schedule with the set deadline. The team has made great progress and achievements this week. At the current rate we will be able to deliver the product right on time and meet the quality
                that is expected of us. Attached are the seminar report held this week by our team and the final product design that needs your approval at the earliest.
              </p>
              <p>
                For the coming week the highest priority is given to the development for
                <a
                  href="javascript:void(0);"
                  target="_blank"
                >http://www.bootstrapdash.com/</a> once the design is approved and necessary improvements are made.
              </p>
              <p>
                <br />
                <br />Regards,
