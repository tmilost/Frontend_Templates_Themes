          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="card-body">
                ...
                <p class="card-description">
                  Add class
                  <code>.btn-{color}</code> for buttons in theme colors
                </p>
            ...
            <div class="col-sm-6">
              <div class="card-body">
                ...
                <div class="template-demo">
                  <b-button class="btn btn-primary btn-rounded btn-fw">Primary</b-button>
                  <b-button class="btn btn-secondary btn-rounded btn-fw">Secondary</b-button>
                  <b-button class="btn btn-success btn-rounded btn-fw">Success</b-button>
                  <b-button class="btn btn-danger btn-rounded btn-fw">Danger</b-button>
                  <b-button class="btn btn-warning btn-rounded btn-fw">Warning</b-button>
                  <b-button class="btn btn-info btn-rounded btn-fw">Info</b-button>
                  <b-button class="btn btn-light btn-rounded btn-fw">Light</b-button>
                  <b-button class="btn btn-dark btn-rounded btn-fw">Dark</b-button>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="card-body">
                ...
                <p class="card-description">
                  Add class
                  <code>.btn-outline-{color}</code> for outline buttons
                </p>
                <div class="template-demo">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-7">
                ...
                <p class="card-description">
                  Add class
                  <code>.btn-icon</code> for buttons with only icons
                </p>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="template-demo mt-4">
                  <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-outline-secondary">
                      <i class="ti-star d-block mb-1"></i>
                      Favourites
                    </button>
                    <button type="button" class="btn btn-outline-secondary">
                      <i class="ti-reload d-block mb-1"></i>
                      Reload
                    </button>
                    <button type="button" class="btn btn-outline-secondary">
                      <i class="ti-user d-block mb-1"></i>
                      Users
                    </button>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="template-demo mt-2">
                  <button class="btn btn-outline-dark btn-icon-text">
                    <i class="ti-apple btn-icon-prepend mdi-36px"></i>
                  ...
                  <button class="btn btn-outline-dark btn-icon-text">
                    <i class="ti-android btn-icon-prepend mdi-36px"></i>
                    <span class="d-inline-block text-left">
          ...
          <div class="card-body">
            ...
            <div class="template-demo">
              ...
              <button type="button" class="btn btn-social-icon-text btn-dribbble">
                <i class="ti-dribbble"></i>Dribbble
              </button>
