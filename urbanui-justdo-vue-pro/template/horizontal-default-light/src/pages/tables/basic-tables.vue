        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">
              ...
              <code>&lt;b-table&gt;</code> supports pagination, filtering, sorting, custom rendering, events, and asynchronous data.
            </p>
      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">
              Use
              <code>hover striped</code> props for striped and hoverable styles
            </p>
      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">Bootstrap contextual state applied to the row and column</p>
