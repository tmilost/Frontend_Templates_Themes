                    ...
                    <div class="row">
                      <div class="col-sm-6 col-lg-5 d-lg-flex">
                        ...
                        <div class="wrapper pl-lg-4">
                          ...
                          <div
                            class="wrapper d-flex align-items-center font-weight-medium text-muted"
                          >
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col d-flex">
                          ...
                          >
                            <i class="ti-light-bulb icon-sm my-0"></i>
                          </div>
                        ...
                        <div class="col d-flex">
                          <div
                            class="d-inline-flex align-items-center justify-content-center border rounded-circle px-2 py-2 my-auto text-muted"
                          >
                            <i class="ti-user icon-sm my-0"></i>
                          </div>
                          <div class="wrapper pl-3">
                        ...
                        <div class="col d-flex">
                          <div
                            class="d-inline-flex align-items-center justify-content-center border rounded-circle px-2 py-2 my-auto text-muted"
                          >
                            <i class="ti-server icon-sm my-0"></i>
                          </div>
                          <div class="wrapper pl-3">
                        ...
                        <div class="col d-flex">
                          <div
                            class="d-inline-flex align-items-center justify-content-center border rounded-circle px-2 py-2 my-auto text-muted"
                          >
                            <i class="ti-pie-chart icon-sm my-0"></i>
                          </div>
                          <div class="wrapper pl-3">
                        ...
                        <div class="col d-flex align-items-center">
                          <div class="image-grouped ml-auto">
                            ...
                            <div
                              ...
                              data-placement="top"
                              title
                              data-original-title="4 More Peoples"
                            >
                              <span class="d-block pt-2">+4</span>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col d-flex align-items-center">
                          <div class="image-grouped ml-auto">
                            ...
                            <div
                              ...
                              data-original-title="4 More Peoples"
                            >
                              <span class="d-block pt-2">+2</span>
                            </div>
                          </div>
                        </div>
                      </div>
